...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks {
    ...
    private val crimeDetailsViewModel: CrimeDetailViewModel by lazy {
...
//        Log.d(TAG, "args bundle crime ID: $crimeId")
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_crime, contaner, false)
...
//                startActivity(intent)
        ...
        suspectButton.apply {
            ...
            //Questionable piece of code (check for messengers and contacts respectively)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when {
            ...
            requestCode == REQUEST_CONTACT && data != null -> {
                ...
                cursor?.use {
                    //Verify the cursor contains at least 1 result
                    if (it.count == 0) {
                        return
                    }

                    //Pull the 1st column of the 1st row of data that is your suspect's name
                    it.moveToFirst()
